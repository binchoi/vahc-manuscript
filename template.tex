...
\teaser{
  \centering
  \includegraphics[width=\linewidth]{MedVizTopicZoom}
  \caption{The screenshot of the labels generated for the semantic map, showing (a) the topic labels of top-level clusters on the overall map, and (b) the detailed topic labels of a zoomed-in area. }
  \label{fig:teaser}
}
